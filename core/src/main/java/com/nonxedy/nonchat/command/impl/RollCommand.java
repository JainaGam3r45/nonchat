...
public class RollCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, String[] args) {
        ...
        // Validate arguments
        if (args.length != 1) {
            MessageUtil.send(sender, ColorUtil.parseComponentCached(messages.getString("invalid-usage-roll")));
        ...
        try {
            ...
            if (maxNumber <= 0) {
                MessageUtil.send(sender, ColorUtil.parseComponentCached(messages.getString("invalid-number")));
